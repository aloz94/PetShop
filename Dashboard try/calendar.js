...
import * as Module from 'https://bryntum.com/products/calendar/build/calendar.module.js?484834';
...
const calendar = new Calendar({
    ...
    crudManager : {
        ...
        transport : {
            load : {
                url : 'https://bryntum.com/products/calendar/examples/filtering/data/data.json',
                credentials : 'omit' // required to bypass CORS at CodePen
            }
        }
    },
